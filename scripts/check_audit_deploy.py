...
# Read deploy script and package.json
CMD = """
echo "=== deploy_auditflow.exp ==="
cat /var/www/triedit-dev/deploy_auditflow.exp

echo "=== frontend/package.json ==="
cat /var/www/triedit-dev/frontend/package.json | grep "scripts" -A 10
"""
