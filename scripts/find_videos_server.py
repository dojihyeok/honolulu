...
# Find videos anywhere
CMD = """
echo "=== Searching for MP4 in /root/honolulu ==="
find /root/honolulu -type f -name "*.mp4" -exec ls -lh {} \;

echo "=== Searching for MP4 in /root (wide search) ==="
find /root -maxdepth 4 -type f -name "*.mp4" -exec ls -lh {} \; | head -n 20
"""
