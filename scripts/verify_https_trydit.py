...
# Verify HTTPS
CMD = """
echo "=== Content of localhost:3009 ==="
curl -s http://127.0.0.1:3009 | grep -o "<title>[^<]*</title>"

echo "=== Content of https://trydit.dojiung.com (via local 443) ==="
curl -k -s -H "Host: trydit.dojiung.com" https://127.0.0.1 | grep -o "<title>[^<]*</title>"
"""
