...
# Rebuild Trydit
CMD = """
echo "=== Checking page.tsx Title ==="
grep "title" /root/antigravity/src/app/page.tsx || echo "No title in page.tsx"

echo "=== Cleaning and Rebuilding Trydit in /root/antigravity ==="
...
echo "=== Starting Trydit on Port 3000 ==="
...
def run_ssh_command(command):
    ...
    if pid == 0:
        ...
        while True:
            if time.time() - timer_start > 120: break # Build takes time
            try:
