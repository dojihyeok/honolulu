...
KEY = './deploy_key.pem'
APP_NAME = 'honolulu'
LOCAL_ARCHIVE = 'update_v3.tar.gz'
...
def deploy():
    ...
    # Aggressive Port Cleanup (3003, 3007 for cleanup, 3005/3006 for legacy)
        "for P in 3003 3007 3005 3006; do PID=$(lsof -t -i:$P); [ ! -z \"$PID\" ] && kill -9 $PID; done || true",
