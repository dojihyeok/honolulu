...
# List /var/www/triedit-dev/
CMD = """
echo "=== /var/www/triedit-dev/ contents ==="
ls -F /var/www/triedit-dev/

echo "=== Searching for requirements.txt in /var/www ==="
find /var/www -name "requirements.txt" -maxdepth 4
"""
